...
function HamburgerMenu({ isOpen, onClose, onAddBook, onImport, onExport, onLoadTestData, onClearAll, hasBooks, user, onSignIn, onSignOut, isFirebaseConfigured }) {
            ...
            <>
              ...
              <div className="hamburger-auth-section">
                {user ? (
                  ...
                  <>
                    <div className="hamburger-auth-hint">Sign in to sync across devices</div>
                    <button className="hamburger-item hamburger-item-primary" onClick={() => handleAction(onSignIn)}>
                      <svg className="hamburger-google-icon" viewBox="0 0 24 24" width="18" height="18">
